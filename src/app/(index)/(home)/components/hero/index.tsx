	...
	return (
		<div className="px-4 py-12 container mx-auto">
			...
			<p className="text-center px-6 mt-3 text-[min(4vw,20px)] text-gray-400 font-normal">
				I'm a developer specializing in crafting elegant solutions to
				complex problems. Proficient in both front-end and back-end
				technologies, I enjoy turning ideas into user-friendly digital
				experiences. With expertise in React, Node.js, and responsive
				design, I create software that functions seamlessly and delights
				users. My commitment to continuous learning keeps me at the
				forefront of technology trends. Let's collaborate to build the
				next generation of digital innovations.
			</p>
...
*/}
				...
				<div className="border border-gray-300 rounded-md px-3 py-6 space-y-3">
					...
					<p className="text-center px-6 mt-3 text-sm text-gray-400">
						Carefully crafted precise design, with harmonious
						typography and perfect padding around every component
					</p>
				</div>
				...
				<div className="border border-gray-300 rounded-md px-3 py-6 space-y-3">
					...
					<p className="text-center px-6 mt-3 text-sm text-gray-400">
						Built with HTML, CSS and JS. Startup’s code is easy to
						under-stand and easy to change. No other frameworks
						needed.
					</p>
				</div>
				...
				<div className="border border-gray-300 rounded-md px-3 py-6 space-y-3">
					...
					<p className="text-center px-6 mt-3 text-sm text-gray-400">
						Transform your ideas into reality and launch a beautiful
						site with minimal frustration.
					</p>
				</div>
			</div>
		</div>
